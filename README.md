...
## Installing Nginx Remotely thorugh Python -- nginx.py
...
Static Website URL: https://harshabucketpython134.s3.us-west-2.amazonaws.com/index.html

Plase note that I have done above tasks in separate files make sure to use the outputs generated by one in another file. Also take care of variables:) 
